...
You MUST end your response with EXACTLY this format. The Confidence number MUST match the class you selected — for example, if you select "Better than even" you MUST write Confidence: 6, not any other number.

Answer: 42
Confidence: 6
Confidence Class: Better than even
Correct: Yes
...
Question: {question}
{choices_text}
First, explicitly reason through the question step by step to arrive at an answer. After reaching your conclusion, explicitly match your diagnosis to one of the answer choices above by restating it (e.g., "This corresponds to option C"). Then, thoroughly assess your confidence in that answer by evaluating your thinking process so far. Finally, classify your confidence into one of the following classes based on how likely your answer is to be correct: 
...
Answer: [your final answer, just the letter, ex., A]
Confidence: [1-10]
Correct: [Yes/No]
